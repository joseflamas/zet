...
void setup()
{
  ...
  lin1 = new Linea(xIL, yIL, coloresAntes[numColor+1], alfa);
...
void draw()
{
  ...
  {
    normi=i;
    if(i>1024||i==1024){ normi = int(norm(i,0,1024)); }
    lin.conectarHorizontal(i, normi, intA, sepLR, anchoL, anchoR, anchoS, coloresAntes[numColor], alfa);
    lin1.conectarVertical(i*5, normi, intA, sepLR*5, anchoL*5, anchoR*5, anchoS, coloresAntes[numColor], alfa);
