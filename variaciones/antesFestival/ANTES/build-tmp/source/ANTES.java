...
public class ANTES extends PApplet {
...
public void draw()
{
  ...
  {
    normi=i;
    if(i>1024||i==1024){ normi = PApplet.parseInt(norm(i,0,buffer)); }
...
class Linea
{
  ...
  public void conectarHorizontal(int I, int NORMI, int INTEN, int DISTI, int A1, int A2 , float GROSLIN, int COLORLINEA, int A)
  {
    ...
    //MIX
    line( x+I, y+DISTI+in0.mix.get(NORMI)*INTEN +50, x+I+1, y+A2+DISTI+in0.mix.get(NORMI)*INTEN+50);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "ANTES" };
    if (passedArgs != null) {
