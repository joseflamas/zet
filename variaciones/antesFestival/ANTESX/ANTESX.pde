...
void draw()
{
  ...
  if ( beat.isSnare() )
    {
         anchoL+=random(-15,15);
         anchoL = (anchoL>15)?int(random(0,95)):anchoL;
         anchoL = (anchoL<0)?0:anchoL;
         
         anchoR+=random(-15,15);
         anchoR = (anchoR>15)?int(random(0,95)):anchoR;
         anchoR = (anchoR<0)?0:anchoR;
         
         sepLR+=random(-50,50);
         sepLR = (anchoR>90)?90:sepLR;
         sepLR = (anchoR<0)?int(random(-55,55)):sepLR;
  ...
  {
    normi=i;
    if(i>buffer||i==buffer){ normi = int(norm(i,0,buffer)); }
